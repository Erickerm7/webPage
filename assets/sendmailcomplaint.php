...
<table width='700' bordercolor='#fff' border='1' cellspacing='0' align='center'>
  ...
  <tr>
    ...
    <td align='center' bgcolor='#E2E2E2'><font color='#353535' face='sans-serif, Geneva, Tahoma'>$depto</font></td>
  </tr>
  <tr>
...
";
    ...
    if($nombres == '') {
        $array['nombresMessage'] = 'Por favor inserte su nombre.';
    }
	if($apellidos == '') {
        $array['apellidosMessage'] = 'Por favor inserte su apellido.';
    }
    ...
    if($message == '') {
        $array['messageMessage'] = 'Por favor escriba su descripción.';
    }
    if($nombres != '' && $apellidos != '' && isEmail($clientEmail) && $message != '' && is_phone($clientPhone) && $phone != '') {
        // Send email
