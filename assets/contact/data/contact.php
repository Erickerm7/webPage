...
if (empty($action)) {
	...
	<div class='contact-content'>
		<h1 class='contact-title'>Describe tu caso:</h1>
	...
	if ($extra["form_cc"]) {
		$output .= "
			<label>&nbsp;</label>
			<input type='checkbox' id='contact-cc' name='cc' value='1' tabindex='1005' /> <span class='contact-cc'>Envíarme una copia.</span>
			<br/>";
	}
	...
	<div class='contact-bottom'><a href='http://www.aceiba.com.gt'>Aseguradora La Ceiba, S.A.</a></div>
</div>";
	...
	if ($token === smcf_token($to)) {
		...
		echo "Lo sentimos, su mensaje no pudo ser verificado.";
	}
}
...
function smcf_send($name, $email, $subject, $message, $cc) {
	...
	$headers .= "X-Mailer: PHP/Aseguradora La Ceiba";
	...
	@mail($to, $subject, $body, $headers) or 
		die("Lo sentimos, un problema del servidor impidió la entrega de su mensaje.");
}
